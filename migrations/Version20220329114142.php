 ...
 */
final class Version20220329114142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD CONSTRAINT FK_D79F6B1148A93A92 FOREIGN KEY (no_site_id) REFERENCES site (id)');
        $this->addSql('CREATE INDEX IDX_D79F6B1148A93A92 ON participant (no_site_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP FOREIGN KEY FK_D79F6B1148A93A92');
        $this->addSql('DROP INDEX IDX_D79F6B1148A93A92 ON participant');
    }
}
